...
function OrderDetails() {
   ...
   const finalOrderStatus=paymentStatus==="Not Paid" ? "Cancelled":order.orderStatus
    ...
    <table className="table-main">
        <tbody>
            ...
            <tr className="table-row">
                ...
                <td className="table-cell"><span className={paymentStatusClass}>{paymentStatus}</span></td>
            </tr>
